...
public class TransactionTest {
    ...
    @Test
    public void createInvoiceWithUnknownProduct() throws Exception {
        float total = myDAO.totalForCustomer(myCustomer.getCustomerId());
        int invoiceCount = myDAO.numberOfInvoicesForCustomer(myCustomer.getCustomerId());
        ...
        assertEquals(total, myDAO.totalForCustomer(myCustomer.getCustomerId()), 0.01f);
        assertEquals(invoiceCount, myDAO.numberOfInvoicesForCustomer(myCustomer.getCustomerId()));
    ...
    @Test
    public void InvalidCountOfProductsAndQuantities() {
        try {
            myDAO.createInvoice(
                    myCustomer,
                    new int[]{1, 2, 5},
            ...
            assertEquals("ProductIds must have the same amount of elements as quantities.", e.getMessage());
        }
    }
}
