...
public class BankingTest {
	...
	public static DataSource getDataSource() throws SQLException {
        ...
        public void transfertWithoutEnoughtMoney() throws Exception {
            myDAO.bankTransferTransaction(0, 1, 200000);
        }
        
        @Test (expected = Exception.class)
        public void transfertWithUnknownSource() throws Exception {
            myDAO.bankTransferTransaction(2, 0, 10);
        }
        
        @Test (expected = Exception.class)
        public void transfertWithUnknownTarget() throws Exception {
            myDAO.bankTransferTransaction(0, 2, 10);
        }
}
