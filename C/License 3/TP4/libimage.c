		...
		double * rp, double * gp, double * bp)
{
  if (v == 0) {
    ...
    *rp = v; *gp = v; *bp = v;
    ...
    switch (i) {
    case 0:  *rp = v;  *gp = tv; *bp = pv; break;
    case 1:  *rp = qv; *gp = v;  *bp = pv; break;
    case 2:  *rp = pv; *gp = v;  *bp = tv; break;
    case 3:  *rp = pv; *gp = qv; *bp = v;  break;
    case 4:  *rp = tv; *gp = pv; *bp = v;  break;
    case 5:  *rp = v;  *gp = pv; *bp = qv; break;
    case 6:  *rp = v;  *gp = tv; *bp = pv; break;
    case -1: *rp = v;  *gp = pv; *bp = qv; break;
    default:
