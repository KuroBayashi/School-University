...
def firstFit():
    global segmentCourant,segmentsALire,memoire
    if(segmentCourant !=len(segmentsALire)):
                
        #on tire au hasard la place du segment à ajouter
        nSeg=segmentsALire[segmentCourant]
        place=randint(0,nb-tailleSeg[nSeg])
...
def majSegmentsLusEtALire():
    global lus,alire,segmentCourant,segmentsALire,tailleSeg
